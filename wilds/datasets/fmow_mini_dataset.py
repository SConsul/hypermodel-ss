...
class FMoWMiniDataset(WILDSDataset):
    """
    ...
    def __init__(self, version=None, root_dir='data', download=False, split_scheme='official', seed=111, use_ood_val=True):
        ...
        self.metadata = pd.read_csv(self.root / 'rgb_metadata_mini.csv')
        self.true_idx = self.metadata['true_idx']
    ...
    def get_input(self, idx):
        ...
        """
        idx = self.true_idx[self.full_idxs[idx]]
